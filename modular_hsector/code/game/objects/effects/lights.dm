/obj/item/decoration
	...
	icon = 'modular_hsector/icons/holidays/new_year/decorations.dmi'
	icon_state = "santa"
	layer = 4.1
...
/obj/item/decoration/halloween
	...
	icon = 'modular_hsector/icons/holidays/halloween/decorations.dmi'
	icon_state = "1"
...
/obj/item/weapon/carved_pumpkin
	...
	var/obj/item/flashlight/flare/candle/candle
	var/candled = FALSE
...
/obj/item/weapon/carved_pumpkin/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/flashlight/flare/candle) && !candle)
		var/obj/item/flashlight/flare/candle/new_candle = I
		if(!new_candle.light_on)
			return
...
/obj/item/decoration/tinsel
	...
	icon = 'modular_hsector/icons/holidays/new_year/tinsel.dmi'
	icon_state = "1"
	var/variations = 4
...
/obj/item/decoration/tinsel/halloween
	...
	icon = 'modular_hsector/icons/holidays/halloween/tinsel.dmi'
	icon_state = "1"
	variations = 20
	random = TRUE
