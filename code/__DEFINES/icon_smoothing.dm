...
//SKYRAT EDIT ADDITION - don't forget to increment
#define SMOOTH_GROUP_SHUTTERS S_OBJ(78)

#define SMOOTH_GROUP_WATER S_OBJ(79) ///obj/effect/abstract/liquid_turf
//SKYRAT EDIT END
//HSECTOR EDIT ADDITION - don't forget to increment
#define SMOOTH_GROUP_LEWD_TENTACLES S_OBJ(80) ///obj/structure/tentacle_lair/weeds
//HSECTOR EDIT END
