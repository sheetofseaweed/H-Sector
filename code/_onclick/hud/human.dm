...
/datum/hud/human/update_locked_slots()
	...
	if(istype(human_mob))
		...
		//hsector add
		var/obj/item/organ/genital/anus/anus = human_mob.get_organ_slot(ORGAN_SLOT_ANUS)
		if(isnull(anus))
			blocked_slots |= ITEM_SLOT_ANUS
		var/obj/item/organ/genital/penis/penis = human_mob.get_organ_slot(ORGAN_SLOT_PENIS)
		if(isnull(penis))
			blocked_slots |= ITEM_SLOT_PENIS
		var/obj/item/organ/genital/vagina/vagina = human_mob.get_organ_slot(ORGAN_SLOT_VAGINA)
		if(isnull(vagina))
