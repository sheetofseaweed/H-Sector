...
/datum/unit_test/ethereal_revival/Run()
	...
	TEST_ASSERT(victim.health == victim.maxHealth, "Ethereal not fully healed after reviving. Maxhealth inacuracy [victim.maxHealth - 120], health inaccuracy [victim.health - 120]")
