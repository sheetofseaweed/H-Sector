...
/datum/opposing_force_equipment/antagonist_powers/mommyclaw
	...
	description = "A slab of Mommy Deathclaw Meat, only recently extracted from a beast hell bent on dragging everyone back to smother them in it's lair on Station Nine. Capable of making one become a \"Mommy Deathclaw\"."
...
/datum/opposing_force_equipment/antagonist_powers/funwolf
	...
	name = "Werewolf Meat"
	description = "A slab of Werewolf Meat, only recently extracted from a rampaging beast hell bent on breeding everything on Icemoon Gamma Nine. Capable of making one become a \"Alpha Werewolf\"."
...
/datum/opposing_force_equipment/antagonist_powers/bitchwolf
	...
	description = "A slab of Werewolf Bitch Meat, only recently extracted from a beast hell bent on dragging everyone back to smother them in it's lair on a crashed research vessel. Capable of making one become a \"Werewolf Bitch\"."
