...
GLOBAL_LIST_INIT(lewd_inventory_ui_styles, list(
	'icons/hud/screen_midnight.dmi' = 'modular_hsector/icons/hud/screen_midnight.dmi',
	'icons/hud/screen_retro.dmi' = 'modular_hsector/icons/hud/screen_retro.dmi',
	'icons/hud/screen_plasmafire.dmi' = 'modular_hsector/icons/hud/screen_plasmafire.dmi',
	'icons/hud/screen_slimecore.dmi' = 'modular_hsector/icons/hud/screen_slimecore.dmi',
	'icons/hud/screen_operative.dmi' = 'modular_hsector/icons/hud/screen_operative.dmi',
	'icons/hud/screen_clockwork.dmi' = 'modular_hsector/icons/hud/screen_clockwork.dmi',
))
...
/datum/hud/update_ui_style(new_ui_style)
	...
	for(var/atom/item in lewd_inventory)
		if (item.icon == initial_ui_style)
			item.icon = lewd_inventory_ui_styles(new_ui_style)
