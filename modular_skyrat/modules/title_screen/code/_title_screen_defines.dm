...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_hsector/icons/UI_Icons/title_screen/hsector_title_screen.png' // HSECTOR EDIT START: TITLE SCREEN - old value: 'modular_skyrat/modules/title_screen/icons/skyrat_title_screen.png'
